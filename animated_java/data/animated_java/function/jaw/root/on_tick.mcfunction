...
execute if entity @s[tag=aj.jaw.animation.jump_init.playing] run function animated_java:jaw/animations/jump_init/zzz/on_tick
execute if entity @s[tag=aj.jaw.animation.jump_loop.playing] run function animated_java:jaw/animations/jump_loop/zzz/on_tick
execute if entity @s[tag=aj.jaw.animation.jump_end.playing] run function animated_java:jaw/animations/jump_end/zzz/on_tick
...
execute if entity @s[tag=aj.jaw.animation.slash.playing] run function animated_java:jaw/animations/slash/zzz/on_tick
