...
execute on passengers if entity @s[tag=aj.global.data] run function animated_java:armor/zzz/1
tag @s remove aj.new
execute if data storage aj:temp args.variant run function animated_java:armor/zzz/3 with storage aj:temp args
