...
execute if entity @s[tag=aj.armor.animation.jump_init.playing] run function animated_java:armor/animations/jump_init/zzz/on_tick
execute if entity @s[tag=aj.armor.animation.jump_loop.playing] run function animated_java:armor/animations/jump_loop/zzz/on_tick
execute if entity @s[tag=aj.armor.animation.jump_end.playing] run function animated_java:armor/animations/jump_end/zzz/on_tick
execute if entity @s[tag=aj.armor.animation.jabs.playing] run function animated_java:armor/animations/jabs/zzz/on_tick
execute if entity @s[tag=aj.armor.animation.rocket.playing] run function animated_java:armor/animations/rocket/zzz/on_tick
