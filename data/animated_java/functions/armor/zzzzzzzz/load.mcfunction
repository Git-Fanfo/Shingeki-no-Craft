...
scoreboard players set $aj.armor.animation.run aj.id 4
scoreboard players set $aj.armor.animation.slide aj.id 5
scoreboard players set $aj.armor.animation.punch_1 aj.id 6
scoreboard players set $aj.armor.animation.punch_2 aj.id 7
scoreboard players set $aj.armor.animation.punch_3 aj.id 8
scoreboard players set $aj.armor.animation.init_charge aj.id 9
scoreboard players set $aj.armor.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.armor.export_version aj.i 1073768260
