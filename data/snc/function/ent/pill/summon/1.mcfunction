data merge entity @s {LeftHanded:0b,Tags:["marleyan","soldier_dmg"],HandDropChances:[0.085F,0.000F],ArmorItems:[{},{},{},{id:"minecraft:feather",count:1,components:{"custom_model_data":1}}],ArmorDropChances:[0F,0F,0F,0F]}
