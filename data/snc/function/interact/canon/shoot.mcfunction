...
summon snowball ^ ^1.1 ^2.7 {Tags:["not_mov","motion_can","snc.projectile"],Passengers:[{id:"minecraft:item_display",teleport_duration:1,item_display:"thirdperson_righthand",Tags:["snc.projectile","snc.canon"],item:{id:"minecraft:player_head", count:1, components:{"custom_model_data":2, "profile":{id:[I;1,1,1,0]}}}}],Item:{id:"minecraft:arrow", Count:1b, components:{"custom_model_data":1}}}
