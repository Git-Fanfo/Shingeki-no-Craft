...
execute store result entity @s Motion[0] double 0.011 run scoreboard players operation @s snc.mot_x1 -= @s snc.mot_x0
execute store result entity @s Motion[1] double 0.011 run scoreboard players operation @s snc.mot_y1 -= @s snc.mot_y0
execute store result entity @s Motion[2] double 0.011 run scoreboard players operation @s snc.mot_z1 -= @s snc.mot_z0
