...
scoreboard players operation motion_x beast_vars -= @s snc.mot_x0
scoreboard players operation motion_y beast_vars -= @s snc.mot_y0
scoreboard players operation motion_z beast_vars -= @s snc.mot_z0
