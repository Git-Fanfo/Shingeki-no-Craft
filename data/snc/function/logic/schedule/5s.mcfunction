...
execute store result score count jaw_vars run execute if entity @e[type=#snc:eldian,scores={jaw_vars=1}]

execute if score count attack_vars matches 0 run bossbar remove minecraft:attack_health
execute if score count armor_vars matches 0 run bossbar remove minecraft:armor_health
execute if score count cart_vars matches 0 run bossbar remove minecraft:cart_health
execute if score count colossal_vars matches 0 run bossbar remove minecraft:colossal_health
execute if score count beast_vars matches 0 run bossbar remove minecraft:beast_health
execute if score count jaw_vars matches 0 run bossbar remove minecraft:jaw_health
...
execute if score count jaw_vars matches 2.. run execute as @e[type=#snc:eldian,scores={jaw_vars=1},tag=!transform,limit=1,sort=arbitrary] run function snc:shifters/transfer/cheat with storage minecraft:jaw