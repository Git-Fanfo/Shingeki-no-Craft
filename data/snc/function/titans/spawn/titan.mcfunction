...
execute if score titan spawn matches 6 run function snc:titans/ai/join_leader {"titan":"titan_7"}
...
## Reset
execute if score titan spawn matches 7.. run scoreboard players set titan spawn 0
