execute if score $titan_drops config matches 1 run summon experience_orb ~.2 ~4 ~ {Value:7}
execute if score $titan_drops config matches 1 run summon experience_orb ~ ~4 ~ {Value:3}
execute if score $titan_drops config matches 1 run summon experience_orb ~ ~4 ~.2 {Value:5}
