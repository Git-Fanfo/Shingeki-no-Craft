...
execute if score @s atk matches 135..136 if entity @s[tag=attack] positioned ^ ^6.5 ^-.2 run function snc:titans/mobs/zick/attack/2 with entity @s item.components."minecraft:custom_data"
execute if score @s atk matches 133..134 if entity @s[tag=attack] positioned ^ ^6.4 ^-1 run function snc:titans/mobs/zick/attack/2 with entity @s item.components."minecraft:custom_data"
execute if score @s atk matches 132 if entity @s[tag=attack] positioned ^ ^6.4 ^-1 run function snc:titans/mobs/zick/attack/2 with entity @s item.components."minecraft:custom_data"