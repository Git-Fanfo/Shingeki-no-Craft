...
## Effects
execute at @s on passengers if entity @s[type=player] run function snc:eldia/respawn/effects
...
## inherit shifter
function snc:shifters/function/unique {"pre":"execute on passengers if entity @s[type=player] run function snc:shifters/transfer/get with storage minecraft:","post":""}
