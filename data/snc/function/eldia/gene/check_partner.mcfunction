...
execute if score @s alma matches 30.. if entity @n[tag=snc.vill.alma,distance=.1..3] run function snc:eldia/gene/bee
execute if score @s julian matches 30.. if entity @n[tag=snc.vill.julian,distance=.1..3] run function snc:eldia/gene/bee
