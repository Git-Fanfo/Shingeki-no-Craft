...
execute positioned ~ ~1 ~ on vehicle rotated as @s positioned ^ ^ ^6 positioned ~-1.5 ~-1.5 ~-1.5 if entity @n[dx=2,dy=2,dz=2] run scoreboard players set state jaw_vars 12