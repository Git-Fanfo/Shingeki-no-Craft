...
summon armor_stand ^ ^ ^ {DisabledSlots:4144959,Invisible:1b,Tags:["jaw","dead","shifter"],Pose:{Head:[-20f,10f,15f]},ArmorItems:[{},{},{},{id:"minecraft:carved_pumpkin",Count:1b,components:{"item_model":"shifters/jaw_misc/bite"}}]}
