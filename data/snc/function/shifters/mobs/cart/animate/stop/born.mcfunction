...
execute if score action cart_vars matches 40 run playsound minecraft:snc.shifters.cart.roar player @a ~ ~ ~ 5 1.05
...
execute if score action cart_vars matches 40 run playsound minecraft:snc.shifters.lightning master @a ~ ~ ~ 24
...
execute if score action cart_vars matches 36 run playsound minecraft:snc.shifters.lightning master @a ~ ~ ~ 24
...
execute if score action cart_vars matches 31 run playsound minecraft:snc.shifters.lightning master @a ~ ~ ~ 24
