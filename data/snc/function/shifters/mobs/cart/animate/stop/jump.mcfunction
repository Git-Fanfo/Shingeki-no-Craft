execute if score action cart_vars matches 10 on vehicle at @s rotated ~ -55 run function snc:logic/motion/generic {"score":"cart_vars","strength":0.014, "unstoppable":"false"}
