execute if score action cart_vars matches 10 on vehicle at @s rotated ~ -30 run function snc:logic/motion/generic {"score":"cart_vars","strength":0.023, "unstoppable":"false"}
