...
$execute if score action cart_vars matches 20 on vehicle on controller run item replace entity @s armor.head with carved_pumpkin[item_model="$(f1)"]
execute if score action cart_vars matches 20 run playsound minecraft:aot.shifters.bite player @a ~ ~ ~ 5 .8
$execute if score action cart_vars matches 18 on vehicle on controller run item replace entity @s armor.head with carved_pumpkin[item_model="$(f2)"]
$execute if score action cart_vars matches 14 on vehicle on controller run item replace entity @s armor.head with carved_pumpkin[item_model="$(f3)"]
