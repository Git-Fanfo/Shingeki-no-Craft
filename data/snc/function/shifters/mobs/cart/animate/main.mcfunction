...
# Bite
execute if score state cart_vars matches 7 run function snc:shifters/mobs/cart/animate/bite
# Roar
execute if score state cart_vars matches 8 run function snc:shifters/mobs/cart/animate/roar
