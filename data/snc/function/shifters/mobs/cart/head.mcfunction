...
execute if score $gamemode cart_vars matches -1 unless score @s jaw_vars matches 1 run item replace entity @s[tag=transform] armor.head with carved_pumpkin[item_model="shifters/cart/bite/farm"]
execute if score $gamemode cart_vars matches -1 if score @s jaw_vars matches 1 run item replace entity @s[tag=transform] armor.head with carved_pumpkin[item_model="shifters/cart/bite/mask_farm"]