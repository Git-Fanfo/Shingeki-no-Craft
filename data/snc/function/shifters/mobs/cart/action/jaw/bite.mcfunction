...
execute if score consume cart_vars matches 8 unless entity @s[tag=snc.bite] anchored eyes run function snc:shifters/mobs/cart/action/jaw/damage with storage minecraft:cart
