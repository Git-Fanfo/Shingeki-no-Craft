$execute positioned ~ ~3 ~ on vehicle rotated as @s positioned ^-1 ^-1 ^3 run function snc:shifters/combat/damage {"distance":6,"half_distance":3,"shifter":"attack","sound":"aot.punch","damage":$(damage_punch_1),"knockback":$(knockback_punch_1),"energy":$(energy_punch_1),"angle":$(angle_punch_1)}
