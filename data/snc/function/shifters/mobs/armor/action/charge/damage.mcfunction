...
execute positioned ~ ~3 ~ on vehicle rotated as @s positioned ^ ^ ^2 run function snc:shifters/combat/damage {"distance":8,"half_distance":4,"shifter":"armor","sound":"","damage":5,"knockback":"1","energy":0,"angle":7}
