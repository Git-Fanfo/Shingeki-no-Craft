...
## Follow combo
execute if score combo_punch armor_vars matches 1 on vehicle on passengers if entity @s[tag=aj.armor.root] run function snc:shifters/mobs/armor/animate/punch_2
