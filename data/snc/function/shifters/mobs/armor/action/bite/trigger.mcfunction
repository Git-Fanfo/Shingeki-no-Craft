...
# Regular Bite
execute if score state armor_vars matches 2 on passengers if entity @s[tag=aj.armor.root,tag=!aj.armor.animation.consume.playing] run function snc:shifters/mobs/sight