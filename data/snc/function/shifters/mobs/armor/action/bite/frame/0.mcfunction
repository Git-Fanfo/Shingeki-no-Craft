tag @s add consume
execute unless score state armor_vars matches 2 on vehicle at @s rotated ~180 -2 run function snc:logic/motion/generic {"score":"attack_vars","strength":0.005}
execute on vehicle run attribute @s minecraft:scale base set 6.7
