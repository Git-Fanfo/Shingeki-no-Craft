...
execute as @e[type=!#snc:pivot,tag=!colossal,distance=..100] unless score @s colossal_vars matches 1 at @s run function snc:shifters/mobs/colossal/action/explosion/damage
