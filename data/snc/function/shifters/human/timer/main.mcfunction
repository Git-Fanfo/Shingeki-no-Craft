...
$execute if entity @s[type=player,tag=first] if score player_health_bar $(shifter)_vars matches ..15 run function snc:shifters/human/check_sneak with storage minecraft:$(shifter)
