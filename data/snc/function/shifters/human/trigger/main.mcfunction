...
# Give muscle
execute if score @s atk matches 266 run item replace entity @s armor.feet with leather_boots[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle_gold},enchantments={levels:{"minecraft:binding_curse":1}},enchantment_glint_override=true,custom_data={snc_blank:true}]
...
# Give muscle
execute if score @s atk matches 265 run item replace entity @s armor.feet with leather_boots[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle},custom_data={snc_blank:true}]
execute if score @s atk matches 265 run item replace entity @s armor.legs with leather_leggings[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle_gold},enchantment_glint_override=true,custom_data={snc_blank:true}]
...
# Give muscle
execute if score @s atk matches 264 run item replace entity @s armor.legs with leather_leggings[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle},custom_data={snc_blank:true}]
execute if score @s atk matches 264 run item replace entity @s armor.chest with leather_chestplate[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle_gold},enchantment_glint_override=true,custom_data={snc_blank:true}]
# Give Boots
...
# Give muscle
execute if score @s atk matches 263 run item replace entity @s armor.chest with leather_chestplate[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle},custom_data={snc_blank:true}]
execute if score @s atk matches 263 run item replace entity @s armor.head with leather_helmet[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle_gold},enchantment_glint_override=true,custom_data={snc_blank:true}]
# Give Leggings
...
# Give muscle
execute if score @s atk matches 262 run item replace entity @s armor.head with leather_helmet[minecraft:hide_tooltip={},trim={material:blank,pattern:muscle},custom_data={snc_blank:true}]
# Give Chestplate
