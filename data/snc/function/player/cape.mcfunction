...
execute if entity @s[tag=snc.hood] run item modify entity @s armor.chest snc:odm/assault/cape_dark
execute if entity @s[tag=!snc.dark.hood] run effect clear @s night_vision
execute if entity @s[tag=!snc.hood] run item modify entity @s armor.chest snc:odm/assault/cape_restore