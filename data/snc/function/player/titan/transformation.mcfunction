...
execute if score @s atk matches 276..289 run effect give @s resistance 1 127 true
execute if score @s atk matches 256..266 run function snc:shifters/function/unique {"pre":"function snc:shifters/human/trigger/main with storage minecraft:","post":""}
