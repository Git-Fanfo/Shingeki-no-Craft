# Spread Titans
execute if entity @s[tag=!near] if predicate snc:chance/5 if score @s snc.time matches 140.. run function snc:titans/spawn/wave
...
execute if score $intro config matches 1 if score @s snc.time matches ..179 run function snc:logic/broadcast/welcome