$summon snowball ^$(distance) ^-.8 ^1.5 {NoGravity:1b,Tags:["not_mov","motion_spe","snc.projectile"],Passengers:[{id:"item_display",teleport_duration:1,item_display:"head",Tags:["snc.projectile","snc.spear"],item:{id:"minecraft:player_head", count:1, components:{"custom_model_data":3, "profile":{id:[I;1,1,1,0]}}}}],Item:{id:"minecraft:arrow",Count:1b,components:{"custom_model_data":1}}}
