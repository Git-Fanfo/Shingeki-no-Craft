...
execute if score @s snc.bullets matches 4 run item modify entity @s weapon.offhand snc:odm/blades/gear/full/3
execute if score @s snc.bullets matches 3 run item modify entity @s weapon.offhand snc:odm/blades/gear/full/2
execute if score @s snc.bullets matches 2 run item modify entity @s weapon.offhand snc:odm/blades/gear/full/1
execute if score @s snc.bullets matches 1 run item modify entity @s weapon.offhand snc:odm/blades/gear/full/0
execute if score @s snc.bullets matches 0 run item modify entity @s weapon.offhand snc:odm/blades/gear_empty
execute if score @s snc.bullets matches 0..4 run item modify entity @s weapon.mainhand snc:odm/blades/gas_trigger_empty

tag @s add snc.reload.blade
