...
execute if predicate snc:odm/has_odm_blade run function snc:player/odm/replace_weapon/blades/load/full_gear
execute unless predicate snc:odm/has_odm_blade run function snc:player/odm/replace_weapon/blades/load/null_gear
