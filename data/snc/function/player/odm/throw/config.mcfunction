execute unless block ~ ~-1 ~ air if predicate snc:odm/lvl/2 if predicate snc:player/is_sneaking if function snc:player/odm/replace_weapon/toggle/lvl_1 run return -1
