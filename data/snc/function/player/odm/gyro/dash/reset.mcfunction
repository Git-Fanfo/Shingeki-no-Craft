...
item modify entity @s armor.chest snc:odm/spin/cape/restore
item modify entity @s armor.legs snc:odm/spin/harness/restore
item modify entity @s armor.feet snc:odm/spin/boots/restore
...
execute if predicate snc:odm/has_gas_trigger run item modify entity @s weapon.mainhand snc:odm/spin/trigger/restore
execute if predicate snc:odm/has_odm run item modify entity @s weapon.offhand snc:odm/spin/gear/restore
