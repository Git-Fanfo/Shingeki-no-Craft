...
$execute if entity @p[name=$(name),distance=..6] run tag @s add snc.wire.break

execute if score @s projectile matches 1 run particle heart ~ ~ ~ 0 0 0 1 1 force
...
$execute if score @s[tag=!snc.wire.break] snc.odm_dist matches ..6 positioned ^ ^ ^7 \
