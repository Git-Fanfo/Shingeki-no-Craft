...
#Throw
execute if score @s[tag=!wrap,tag=!snc.injured] odm_state matches 0 if predicate snc:odm/has_gas_trigger if predicate snc:odm/has_odm run function snc:player/odm/throw/config
