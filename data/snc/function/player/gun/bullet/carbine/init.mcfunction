...
execute if score @s random matches 1 run playsound aot.human.gun.carbine.shot player @a ~ ~ ~ 8.5 0.9
execute if score @s random matches 2 run playsound aot.human.gun.carbine.shot player @a ~ ~ ~ 8.5 1
execute if score @s random matches 3 run playsound aot.human.gun.carbine.shot player @a ~ ~ ~ 8.5 1.1
