...
execute if score @s odm_action matches -30 if predicate snc:odm/has_spear_l if score @s odm_dmg_R > @s odm_dmg_L run function snc:player/odm/replace_weapon/thunder/main {"side":"L","distance":1,"piece":"gear","hand":"off"}
