...
execute if predicate snc:player/is_warm if items entity @s container.* minecraft:quartz[custom_data~{snc.iceburst:1b}] run function snc:player/odm/throw/remove