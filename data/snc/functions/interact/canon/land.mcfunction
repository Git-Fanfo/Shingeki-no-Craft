...
# fill ~ ~ ~ ~ ~-2 ~ air destroy
# fill ~ ~-1 ~1 ~ ~-1 ~-1 air destroy
summon firework_rocket ~ ~ ~ {Owner:[I;1,1,1,1],Tags:["snc.projectile","water"],LifeTime:1,FireworksItem:{id:"firework_rocket",Count:1,tag:{Fireworks:{Explosions:[{Type:0,Colors:[I;8947848]}]}}}}
