...
execute if score init config matches 4 run tellraw @a ["\n\n\n\n\n\n\n\n\n\n",{"translate":"aot.init.1","color":"white"},{"translate":"aot","color":"dark_red"},"! ",{"translate":"aot.init.2","color":"white"},"\n"]
...
execute if score init config matches 7 run tellraw @a [" * ",{"translate":"aot.init.4","color":"light_purple","clickEvent":{"action":"run_command","value":"/trigger manual set 8"},"hoverEvent":{"action":"show_text","contents":[{"translate":"aot.patreon3","color":"yellow"}]}}]

execute if score init config matches 7 run tellraw @a ["\n * ",{"translate":"aot.init.5","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger manual set 9"},"hoverEvent":{"action":"show_text","contents":[{"translate":"aot.patreon3","color":"yellow"}]}},"\n"]
