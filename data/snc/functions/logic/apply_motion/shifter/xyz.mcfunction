...
$scoreboard players operation motion_x $(shifter)_vars -= @s motion_x0
$scoreboard players operation motion_y $(shifter)_vars -= @s motion_y0
$scoreboard players operation motion_z $(shifter)_vars -= @s motion_z0
