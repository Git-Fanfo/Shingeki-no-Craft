...
execute if score @s random matches 2 run tellraw @s ["<Ragnaar> ","Over here stranger."]
execute if score @s random matches 3 run tellraw @s ["<Ragnaar> ","Ahh.. i'll buy it at a high price."]
