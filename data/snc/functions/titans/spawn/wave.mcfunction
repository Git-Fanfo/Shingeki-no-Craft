...
execute if score $titn_spwn_rate config matches 1..3 if predicate snc:chance/70 run summon item_display ~ ~20 ~ {Tags:["titan","snc.titan.spawn"]}
execute if score $titn_spwn_rate config matches 2..3 if predicate snc:chance/60 run summon item_display ~ ~20 ~ {Tags:["titan","snc.titan.spawn"]}
