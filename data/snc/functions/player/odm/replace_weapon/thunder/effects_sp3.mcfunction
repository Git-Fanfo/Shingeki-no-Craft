...
effect give @s[team=soldier] slowness 2 4 true
effect give @s[team=veteran] slowness 2 3 true
effect give @s[team=leader] slowness 2 2 true
effect give @s[team=officer] slowness 2 1 true
effect give @s[team=squad] slowness 2 0 true