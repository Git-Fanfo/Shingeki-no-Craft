...
## Effects
execute if score ticks clock matches 19 if predicate snc:has_odm run function snc:player/odm/effects
...
execute if score @s odm_action matches 0.. if block ~ ~-.5 ~ air if predicate snc:is_sneaking run function snc:player/odm/trigger_spear
