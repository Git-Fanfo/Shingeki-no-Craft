...
execute if data entity @s Item.components."minecraft:custom_data".3_titan as @p[scores={attack_vars=1},tag=transform] run function snc:give/item/attack/primary
