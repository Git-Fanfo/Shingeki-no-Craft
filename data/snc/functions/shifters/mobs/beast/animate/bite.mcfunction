...
execute if score consume attack_vars matches 12 anchored eyes positioned ^ ^ ^5 run function snc:shifters/mobs/beast/action/jaw/damage with storage minecraft:beast
