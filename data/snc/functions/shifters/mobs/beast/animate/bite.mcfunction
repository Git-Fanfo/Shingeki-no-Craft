...
execute if score consume attack_vars matches 12 anchored eyes positioned ^ ^ ^3.5 as @e[distance=..4.5,tag=!beast,type=!item_display] run function snc:shifters/mobs/beast/action/jaw/damage with storage minecraft:beast
