# Add tag
execute unless entity @s[type=player,tag=titan] run effect give @s[distance=..7] glowing 1 0 true
execute unless entity @s[type=player,tag=titan] as @s[distance=..7] run tag @s add beast_wrap
# Remove tag
