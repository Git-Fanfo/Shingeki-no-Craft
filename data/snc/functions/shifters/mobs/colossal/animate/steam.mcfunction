...
execute if score action colossal_vars matches 220 run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 4 .7
...
execute if score action colossal_vars matches 170 run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 4 .7
...
execute if score action colossal_vars matches 120 run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 4 .7
...
execute if score action colossal_vars matches 70 run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 4 .7
...
execute if score action colossal_vars matches 20 run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 4 .7
