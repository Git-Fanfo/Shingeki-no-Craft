...
execute if score state colossal_vars matches 12 run item replace entity @s armor.head with carved_pumpkin[custom_model_data=11]
execute unless score state colossal_vars matches 12 run item replace entity @s armor.head with carved_pumpkin[custom_model_data=16]
