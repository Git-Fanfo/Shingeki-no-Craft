execute if score $vanish colossal_vars matches 1 run scoreboard players set @s colossal_vars 0
execute if score $vanish colossal_vars matches 1 run scoreboard players reset $vanish colossal_vars
...
execute if score @s colossal_vars matches 1078 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 457
execute if score @s colossal_vars matches 1076 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 456
execute if score @s colossal_vars matches 1074 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 455
execute if score @s colossal_vars matches 1073 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 454
execute if score @s colossal_vars matches 1070 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 455
execute if score @s colossal_vars matches 1068 if score $form colossal_vars matches 1 on passengers run data modify entity @s item.components.minecraft:custom_model_data set value 454
