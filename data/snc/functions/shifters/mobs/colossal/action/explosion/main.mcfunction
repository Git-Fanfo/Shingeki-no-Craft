...
# Gamma
execute as @s[tag=snc.top] if score @s colossal_vars matches 1000 run data merge entity @s {item:{tag:{CustomModelData:465}}}
execute as @s[tag=snc.base] if score @s colossal_vars matches 1000 run data merge entity @s {item:{tag:{CustomModelData:464}}}
execute as @s[tag=snc.top] if score @s colossal_vars matches 1100 run data merge entity @s {item:{tag:{CustomModelData:467}}}
execute as @s[tag=snc.base] if score @s colossal_vars matches 1100 run data merge entity @s {item:{tag:{CustomModelData:466}}}
