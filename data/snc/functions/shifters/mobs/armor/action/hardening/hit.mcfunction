...
$execute if score $op.hardening $(shifter)_vars matches 1.. run playsound aot.shifters.armor.harden.hit player @a ~ ~ ~ 5 1
$execute if score $op.hardening $(shifter)_vars matches 0 run playsound aot.shifters.armor.harden.break player @a ~ ~ ~ 5 1
