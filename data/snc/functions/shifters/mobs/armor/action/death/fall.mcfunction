ride @s dismount
#summon armor_stand ^ ^ ^ {Invisible:1b,Tags:["armor","dead","shifter"],ArmorItems:[{},{},{},{id:"minecraft:carved_pumpkin",Count:1b,components:{"custom_model_data":27}}]}
summon armor_stand ^ ^ ^ {Invisible:1b,Tags:["armor","dead","shifter"]}
