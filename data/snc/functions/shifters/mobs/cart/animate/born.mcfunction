...
execute if score action cart_vars matches 40 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:38}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 36 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:39}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 32 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:40}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 28 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:41}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 24 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:42}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 20 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:43}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 16 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:44}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 12 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:45}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 8 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:46}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 4 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:47}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
execute if score action cart_vars matches 1 run data merge entity @s {item:{id:'minecraft:scute',Count:1b,tag:{CustomModelData:48}}, transformation:{scale:[5.3f,5.3f,5.3f]}}
