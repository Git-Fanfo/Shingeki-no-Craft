...
execute if score $mask cart_vars matches 1 run item replace entity @s armor.head with carved_pumpkin[custom_model_data=4]
execute if score $mask cart_vars matches 0 run item replace entity @s armor.head with carved_pumpkin[custom_model_data=7]
