...
## Change variant
execute if score @s cart_vars matches 1200 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":48}}}
execute if score @s cart_vars matches 1190 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":49}}}
execute if score @s cart_vars matches 1180 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":50}}}
#4
execute if score @s cart_vars matches 1176 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":51}}}
execute if score @s cart_vars matches 1172 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":52}}}
execute if score @s cart_vars matches 1168 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":53}}}
execute if score @s cart_vars matches 1165 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":54}}}
execute if score @s cart_vars matches 1162 on passengers run data merge entity @s {item:{id:'minecraft:turtle_scute',Count:1b,components:{"custom_model_data":55}}}
#8
