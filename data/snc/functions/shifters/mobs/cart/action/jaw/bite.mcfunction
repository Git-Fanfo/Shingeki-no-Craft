...
execute if score consume cart_vars matches 8 anchored eyes positioned ^ ^ ^3 run function snc:shifters/mobs/cart/action/jaw/damage with storage minecraft:cart
