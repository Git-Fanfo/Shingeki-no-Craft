...
summon armor_stand ~ ~ ~ {Invisible:1b,Small:1b,Tags:["pivot","shifter","cart"],Passengers:[{id:"minecraft:item_display",item_display:"head",Tags:["model","shifter","cart"],item:{id:"minecraft:scute",Count:1b,tag:{CustomModelData:37}}}]}
