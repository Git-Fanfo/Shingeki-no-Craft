...
execute as @e[type=!#snc:fireball,tag=!colossal,distance=..100] unless score @s colossal_vars matches 1 run function snc:shifters/mobs/colossal/action/explosion/damage
