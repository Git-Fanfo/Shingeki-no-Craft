...
$execute if score $trigger_transform config matches 1 if entity @s[tag=!transform,tag=!snc.handcuffs] if score $energy $(shifter)_vars matches 720.. run function snc:shifters/human/transform {"shifter":$(shifter),"name":"$(name)"}
