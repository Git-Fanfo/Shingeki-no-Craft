$execute unless score $destroy_when_spawn $(shifter)_vars matches -1 unless score $destroy_when_spawn $(shifter)_vars matches 1 run scoreboard players set $destroy_when_spawn $(shifter)_vars 1

$scoreboard players operation $destroy_when_spawn $(shifter)_vars *= #-1 constant
